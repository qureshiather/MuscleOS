...
export const EXERCISES: Exercise[] = [
  ...
  { id: 'hip-abductor', name: 'Hip Abductor', muscles: ['glutes'], equipment: ['machine'], instructions: 'Sit in machine with pads on outer thighs, push legs apart against resistance, return with control.' },
  { id: 'hip-adductor', name: 'Hip Adductor', muscles: ['glutes'], equipment: ['machine'], instructions: 'Sit in machine with pads on inner thighs, squeeze legs together against resistance, return with control.' },
  ...
  { id: 'pendulum-squat', name: 'Pendulum Squat', muscles: ['quads', 'glutes', 'hamstrings'], equipment: ['machine'], instructions: 'Stand in pendulum squat machine, back against pad, squat down with controlled motion, drive through heels to stand.' },
