...
| [Accounts & sync](../features/accounts-and-data.md) | Partial | Unit conversion, active-workout persist/resume, linked provider resolution, already-linked identity vs in-place upgrade, Delete account wipe, and email confirm/recovery link parsing. Merge policy and live auth/sync untested |
